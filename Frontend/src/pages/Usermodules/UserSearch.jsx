...
import 'C:/Users/mohan/demo/src/assets/css/user/usersearch.css'

export default function UserSearch () {
  return (
    <div className='usersearch grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
        <form action=''>
            <div className='firstdiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-greyIsh-700'>
                <div className='flex gap-2 items-center'>
                    ...
                    focus:outline-none w-[100%]' placeholder='Search Your Job Input' />
        ...
        <div className='searchsec flex items-center gap-10 justify-center'>
